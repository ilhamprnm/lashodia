import {cart, saveToStorage, loadAmount, loadFromStorage, totalPrice} from "./scripts/cart.js"
...
cart.forEach((cartItem) => {
  productsHTML += `
  <div class="flex rounded-lg mt-4 shadow-all-side bg-white">
  ...
  cartSummary += `
    <div class="flex justify-between">
      <div class="flex">
        <div class="w-[220px] h-7 mr-10 overflow-hidden text-ellipsis whitespace-nowrap">
